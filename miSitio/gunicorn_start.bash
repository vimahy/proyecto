...
NAME="miSitio"                                   # Name of the application
DJANGODIR=/opt/projecto/              # Django project directory
SOCKFILE=/opt/projecto/django_env/run/gunicorn.sock  # we will communicte using this unix socket

...
urlpatterns = [
    ...
    url(r"^actualizar_domicilio/$", ActualizarDomicilioView.as_view(), name="actualizar_domicilio"),
    url(r"^actualizar_profesional/$", ActualizarDomicilioProView.as_view(), name="actualizar_profesional"),
